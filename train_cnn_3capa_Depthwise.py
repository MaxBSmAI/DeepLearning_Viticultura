...
def train_student_with_early_stopping(student_model, teacher_model, train_loader, val_loader,
    ...
    for epoch in range(epochs):
        ...
        torch.save(student_model.state_dict(), "student_model_3capa_depthwise.pth")
...
if __name__ == "__main__":
    ...
    if os.path.exists("student_model_3capa_depthwise.pth"):
        size_mb = os.path.getsize("student_model_3capa_depthwise.pth") / (1024 * 1024)
    ...
    performance_assessment_student(student_model, val_loader, model_path_student="student_model_3capa_depthwise.pth")
