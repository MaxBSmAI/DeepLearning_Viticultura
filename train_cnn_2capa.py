...
class StudentCNN(nn.Module):
    def __init__(self, num_classes=4):
        ...
        self.features_student = nn.Sequential(
            ...
            nn.BatchNorm2d(32), 
            nn.ReLU(),
            nn.MaxPool2d(2),  # ↓ tamaño a 112x112 si entras con 224x224

        # Capa convolucional 2
            nn.Conv2d(32, 64, kernel_size=3, padding=1),
            nn.BatchNorm2d(64), 
            nn.ReLU(),
            nn.MaxPool2d(2)   # ↓ tamaño a 56x56
        )
...
def train_student_with_early_stopping(student_model, teacher_model, train_loader, val_loader,
    ...
    for epoch in range(epochs):
        ...
        torch.save(student_model.state_dict(), "student_model_cnn_2capa.pth")
...
if __name__ == "__main__":
    ...
    if os.path.exists("student_model_cnn_2capa.pth"):
        size_mb = os.path.getsize("student_model_cnn_2capa.pth") / (1024 * 1024)
    ...
    performance_assessment_student(student_model, val_loader, model_path_student="student_model_cnn_2capa.pth")
